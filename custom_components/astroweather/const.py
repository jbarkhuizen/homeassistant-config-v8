...
DEFAULT_CONDITION_CLOUDCOVER_WEIGHT = 60
DEFAULT_CONDITION_CLOUDCOVER_HIGH_WEAKENING = 40   # cirrus is largely transparent
DEFAULT_CONDITION_CLOUDCOVER_MEDIUM_WEAKENING = 70  # altocumulus is semi-opaque
DEFAULT_CONDITION_CLOUDCOVER_LOW_WEAKENING = 100    # stratus/fog blocks fully
DEFAULT_CONDITION_FOG_WEIGHT = 60
DEFAULT_CONDITION_SEEING_WEIGHT = 40
DEFAULT_CONDITION_TRANSPARENCY_WEIGHT = 20
DEFAULT_CONDITION_CALM_WEIGHT = 40
...
ATTR_WEATHER_GFS_SUPPLEMENTARY_DATA = "gfs_supplementary_data"
